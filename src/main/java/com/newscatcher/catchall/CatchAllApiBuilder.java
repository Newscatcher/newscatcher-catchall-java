...
public class CatchAllApiBuilder {
     ...
     * Sets apiKey
     */
    public CatchAllApiBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public CatchAllApiBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public CatchAllApiBuilder url(String url) {
     ...
     */
    public CatchAllApiBuilder timeout(int timeout) {
     ...
     */
    public CatchAllApiBuilder maxRetries(int maxRetries) {
     ...
     */
    public CatchAllApiBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public CatchAllApiBuilder logging(LogConfig logging) {
     ...
     */
    public CatchAllApiBuilder addHeader(String name, String value) {
    ...
    public CatchAllApi build() {
        if (apiKey == null) {
            throw new RuntimeException("Please provide apiKey");
        }
        validateConfiguration();
        return new CatchAllApi(buildClientOptions());
    }
}
