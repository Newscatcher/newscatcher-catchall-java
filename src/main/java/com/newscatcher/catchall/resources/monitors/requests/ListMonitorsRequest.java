...
@JsonDeserialize(builder = ListMonitorsRequest.Builder.class)
public final class ListMonitorsRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListMonitorsRequest && equalTo((ListMonitorsRequest) other);
    }
    ...
    public static final class Builder {
        ...
        public ListMonitorsRequest build() {
            return new ListMonitorsRequest(page, pageSize, search, ownership, projectId, additionalProperties);
        }
