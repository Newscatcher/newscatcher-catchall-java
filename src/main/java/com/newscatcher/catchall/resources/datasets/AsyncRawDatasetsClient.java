...
public class AsyncRawDatasetsClient {
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new CatchAllApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, DatasetListResponse.class),
                                response));
                        return;
                    }
                    try {
     ...
     * endpoint instead.</p>
     */
    public CompletableFuture<CatchAllApiHttpResponse<DatasetResponse>> createDataset(CreateDatasetRequest request) {
     ...
     * endpoint instead.</p>
     */
    public CompletableFuture<CatchAllApiHttpResponse<DatasetResponse>> createDataset(
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new CatchAllApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, DatasetResponse.class),
                                response));
                        return;
                    }
                    try {
     ...
     */
    public CompletableFuture<CatchAllApiHttpResponse<CreateDatasetCsvResponse>> createDatasetFromCsv(
     ...
     */
    public CompletableFuture<CatchAllApiHttpResponse<DatasetResponse>> getDataset(String datasetId) {
     ...
     * Returns a single dataset by ID including entity count and current status.
     */
    public CompletableFuture<CatchAllApiHttpResponse<DatasetResponse>> getDataset(
     ...
     * undone.
     */
    public CompletableFuture<CatchAllApiHttpResponse<Void>> deleteDataset(String datasetId) {
     ...
     * undone.
     */
    public CompletableFuture<CatchAllApiHttpResponse<Void>> deleteDataset(
            String datasetId, RequestOptions requestOptions) {
     ...
     */
    public CompletableFuture<CatchAllApiHttpResponse<Void>> deleteDataset(
            String datasetId, DeleteDatasetRequest request) {
     ...
     */
    public CompletableFuture<CatchAllApiHttpResponse<DatasetResponse>> updateDataset(String datasetId) {
     ...
     * Updates the name or description of a dataset.
     */
    public CompletableFuture<CatchAllApiHttpResponse<DatasetResponse>> updateDataset(
            String datasetId, RequestOptions requestOptions) {
     ...
     */
    public CompletableFuture<CatchAllApiHttpResponse<DatasetResponse>> updateDataset(
            String datasetId, UpdateDatasetRequest request) {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new CatchAllApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, DatasetStatusHistoryResponse.class),
                                response));
                        return;
                    }
                    try {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new CatchAllApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, UploadCsvToDatasetResponse.class),
                                response));
                        return;
                    }
                    try {
