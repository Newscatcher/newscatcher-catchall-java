...
import com.newscatcher.catchall.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncCatchAllApiBuilder {
     ...
     * Sets apiKey
     */
    public AsyncCatchAllApiBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public AsyncCatchAllApiBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AsyncCatchAllApiBuilder url(String url) {
     ...
     */
    public AsyncCatchAllApiBuilder timeout(int timeout) {
     ...
     */
    public AsyncCatchAllApiBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncCatchAllApiBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncCatchAllApiBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncCatchAllApiBuilder addHeader(String name, String value) {
    ...
    public AsyncCatchAllApi build() {
        if (apiKey == null) {
            throw new RuntimeException("Please provide apiKey");
        }
        validateConfiguration();
        return new AsyncCatchAllApi(buildClientOptions());
    }
}
